...
/**
 * Material_item form base class.
 *
 * @method Material_item getObject() Returns the current form's model object
 *
 * @package    usuario
 * @subpackage form
 ...
 */
abstract class BaseMaterial_itemForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('material_item[%s]');
