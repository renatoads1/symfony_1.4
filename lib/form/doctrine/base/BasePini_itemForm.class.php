...
/**
 * Pini_item form base class.
 *
 * @method Pini_item getObject() Returns the current form's model object
 *
 * @package    usuario
 * @subpackage form
 ...
 */
abstract class BasePini_itemForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'classe'         => new sfValidatorString(array('max_length' => 255)),
    ...
    $this->widgetSchema->setNameFormat('pini_item[%s]');
