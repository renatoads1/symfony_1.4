...
/**
 * lpu_servico form base class.
 *
 * @method lpu_servico getObject() Returns the current form's model object
 *
 * @package    usuario
 * @subpackage form
 ...
 */
abstract class Baselpu_servicoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('lpu_servico[%s]');
