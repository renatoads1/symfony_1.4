...
/**
 * Servico_item form base class.
 *
 * @method Servico_item getObject() Returns the current form's model object
 *
 * @package    usuario
 * @subpackage form
 ...
 */
abstract class BaseServico_itemForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('servico_item[%s]');
