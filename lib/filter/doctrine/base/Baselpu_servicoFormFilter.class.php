...
/**
 * lpu_servico filter form base class.
 *
 * @package    usuario
 * @subpackage filter
 ...
 */
abstract class Baselpu_servicoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('lpu_servico_filters[%s]');
