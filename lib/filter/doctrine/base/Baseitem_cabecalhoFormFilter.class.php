...
/**
 * item_cabecalho filter form base class.
 *
 * @package    usuario
 * @subpackage filter
 ...
 */
abstract class Baseitem_cabecalhoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('item_cabecalho_filters[%s]');
