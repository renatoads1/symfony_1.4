...
/**
 * Servico_item filter form base class.
 *
 * @package    usuario
 * @subpackage filter
 ...
 */
abstract class BaseServico_itemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('servico_item_filters[%s]');
