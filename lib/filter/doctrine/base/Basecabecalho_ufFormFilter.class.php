...
/**
 * cabecalho_uf filter form base class.
 *
 * @package    usuario
 * @subpackage filter
 ...
 */
abstract class Basecabecalho_ufFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cabecalho_uf_filters[%s]');
