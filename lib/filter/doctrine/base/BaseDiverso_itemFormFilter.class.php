...
/**
 * Diverso_item filter form base class.
 *
 * @package    usuario
 * @subpackage filter
 ...
 */
abstract class BaseDiverso_itemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('diverso_item_filters[%s]');
