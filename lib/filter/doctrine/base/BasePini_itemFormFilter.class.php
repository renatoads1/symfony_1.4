...
/**
 * Pini_item filter form base class.
 *
 * @package    usuario
 * @subpackage filter
 ...
 */
abstract class BasePini_itemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('pini_item_filters[%s]');
