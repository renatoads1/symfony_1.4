 ...
 * @method sfGuardGroup        setServicos()               Sets the current record's "Servicos" collection
 ...
 * @method sfGuardGroup        setGroup()                  Sets the current record's "Group" collection
 * 
 * @package    usuario
 * @subpackage model
...
abstract class BasesfGuardGroup extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('servico_grupo as Group', array(
             'local' => 'id',
             'foreign' => 'group_id'));
